    ...
    renderItems: function(items) {
        ...
        `
         <li class="item__card" data-product-id="${id}">
            <a class="image__wrapper" href="/card/card.html?id=${id}" class="image__wrapper"> 
          ...
          <div class="price-wrapper">
             ...
             <button class="add-bag" data-id=${id} data-articul=${id}">
              <img class="add-bag" data-articul=${id} src="./Button.png">
             </button>    
         </div>
        </li>
      ` 
      ...
      renderOrdersPreview: function(orders) {
        let out = '';
         orders.forEach(order => {
          out += `
             <a class="order-one bag__orders-text" href="/order/orders.html?id=${order.id}"># ${order.id};</a>
