import{L as Hs,a as d,_ as Bs,C as Gs,r as Ut,s as b,j as gt,c as V,b as qs,S as Vs,d as Ks,e as ae,m as Pe,f as Te,g as Ys,h as zs,i as wn,D as Rn,k as js,l as $s,n as Ht,o as Nn,p as Qs,q as Xs,t as Ge,u as Js,v as Zs,w as ei,x as ti,y as ni,E as si,z as ii}from"./storage-724XkIP6.js";import{c as ri}from"./storageOrders-Crj3oSg9.js";import{c as oi}from"./modelOrders-C599NMRw.js";let Ae;const li=new Uint8Array(16);function ai(){if(!Ae&&(Ae=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!Ae))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return Ae(li)}const N=[];for(let n=0;n<256;++n)N.push((n+256).toString(16).slice(1));function ci(n,e=0){return N[n[e+0]]+N[n[e+1]]+N[n[e+2]]+N[n[e+3]]+"-"+N[n[e+4]]+N[n[e+5]]+"-"+N[n[e+6]]+N[n[e+7]]+"-"+N[n[e+8]]+N[n[e+9]]+"-"+N[n[e+10]]+N[n[e+11]]+N[n[e+12]]+N[n[e+13]]+N[n[e+14]]+N[n[e+15]]}const hi=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),Bt={randomUUID:hi};function ui(n,e,t){if(Bt.randomUUID&&!e&&!n)return Bt.randomUUID();n=n||{};const s=n.random||(n.rng||ai)();if(s[6]=s[6]&15|64,s[8]=s[8]&63|128,e){t=t||0;for(let i=0;i<16;++i)e[t+i]=s[i];return e}return ci(s)}function di(n){const e=document.querySelector(n);return{node:e,renderItems:function(t){t.forEach(s=>{const{id:i,model:r,series:o,price:l,image:a}=s,c=`
